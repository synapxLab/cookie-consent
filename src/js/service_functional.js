/**
 * @synapxlab/cookie-consent - service_functional
 * Point central pour les services fonctionnels (chat, support, etc.)
 * 
 * @version 2.4.1
...
// ——— API exportée ———
export const service_functional = {
  ...
  /** charge tous les services configurés (à appeler seulement si consentement « functional » = true) */
  loadAll(cfg) {
