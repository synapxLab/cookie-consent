...
window.CookieConsent.init({
 ...
 logger: {
    ...
    apiKey: 'your-secret-key',        // Optionnel : Option B — Abonnement (recommandé) 
    anonymousId: true,                // Génère un ID pseudo-anonyme (cc_xxx)
    includeUserAgent: true,           // Inclut le User-Agent (hashé côté serveur)
    retries: 3,                       // Nombre de tentatives en cas d'échec
    timeout: 5000,                    // Timeout en millisecondes
    headers: {
      'X-CSRF-TOKEN': 'qqqqqqqqqqqqqqqqqqqqqqqq'
    }
  },
